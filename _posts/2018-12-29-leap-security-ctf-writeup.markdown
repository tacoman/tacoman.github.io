...
the CTF had opened hours before it was scheduled- closer to noon UTC than noon EST. And of cours time was the tiebreaker.
Time to get to work.
...
as the game did. The obvious conclusion was that [the opening tweet](https://twitter.com/LeapSecurity/status/1073934006448783360)
...
in a tweet from November 15th; I never scrolled that far back because I'd been certain the info must have been released today.
...
just register an account and read the forums for a little bit, and then you gained posted privileges and the rights to
...
Calling `register` would add your IP address to this list; a sort of hall of shame, arguably. 
...
Next we passed an invalid filename. Jackpot; the request crashed, returning back a full error trace that revealed that the c2 server's
